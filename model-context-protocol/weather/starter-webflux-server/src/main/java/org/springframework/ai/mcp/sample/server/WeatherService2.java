...
public class WeatherService2 {
	...
	public String getWeatherForecastByLocation2(double latitude, double longitude) {
	...
	public String getAlerts2(String state) {
	...
	public static void main(String[] args) {
		WeatherService2 client = new WeatherService2();
		System.out.println(client.getWeatherForecastByLocation2(47.6062, -122.3321));
		System.out.println(client.getAlerts2("NY"));
	}
